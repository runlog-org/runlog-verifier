...
// driver (see python.go); other isolation values declared by the
// schema (subprocess, compiler, database, http_client, docker_daemon)
// are recognised by the registry but not yet implemented — callers
